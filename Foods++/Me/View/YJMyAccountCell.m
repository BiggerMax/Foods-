...
+ (instancetype)cellWithTableView:(UITableView *)tableView
{
	...
	YJMyAccountCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
	if (cell == nil) {
		cell = [[YJMyAccountCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
